...
const LedgerImage = ({ animate }) => {
    ...
    return (
        <Container width="259" height="111" viewBox="0 0 259 111" fill="none" xmlns="http://www.w3.org/2000/svg" className={animate ? 'animate' : ''}>
            ...
            <rect y="85.2336" width="53.4647" height="2.32455" fill="url(#paint0_linear)"/>
            ...
            <defs>
                <linearGradient id="paint0_linear" x1="53.4647" y1="86.3959" x2="0.387428" y2="86.3959" gradientUnits="userSpaceOnUse">
