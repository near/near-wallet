...
import { getLedgerKey, checkCanEnableTwoFactor, getAccessKeys, redirectTo, refreshAccount, getProfileBalance, transferAllFromLockup, loadRecoveryMethods, updateStakingAccount, updateStakingLockup } from '../../actions/account'
                ...
                <div className='left'>
                    ...
                    {profileBalance ? (
                        <BalanceContainer
                            ...
                            actionMain={() => dispatch(updateStakingAccount(isOwner ? undefined : account.accountId))}
                            actionLockup={() => dispatch(updateStakingLockup(isOwner ? undefined : account.accountId))}
                        />
                    ) : (
                        <SkeletonLoading
                            height='323px'
