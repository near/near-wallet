...
import {
  AuthorizedAppsWithRouter,
  FullAccessKeysWithRouter,
} from './access-keys/AccessKeys';
    ...
    const setTab = (nextTab) => {
      if (tab !== nextTab) {
        ...
        this.props.history.push({
          search: destinationSearch.toString(),
          hash,
        });
      }
    };
      ...
      >
        ...
        <ConnectedRouter basename={PATH_PREFIX} history={this.props.history}>
          ...
          <Switch>
            ...
            <GuestLandingRoute
              ...
              render={(props) =>
                isInactiveAccount ? (
                  ...
                  <Wallet tab={tab} setTab={setTab} {...props} />
                )
              }
            ...
            />
            <Route exact path='/sign-in-ledger' component={SignInLedger} />
            <PrivateRouteLimited path='/login' component={LoginWithRouter} />
            <PrivateRouteLimited
              exact
            ...
            />
            <PrivateRouteLimited exact path='/buy' component={BuyNear} />
            ...
            {!isInactiveAccount && (
              <PrivateRouteLimited
                ...
                render={() => <StakingContainer history={this.props.history} />}
              />
            )}
            <Route
              exact
