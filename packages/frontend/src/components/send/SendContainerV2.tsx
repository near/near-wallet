            ...
            case VIEWS.ENTER_RECEIVER:
                return (
                    <EnterReceiver
                        ...
                        selectedToken={selectedToken}
                        handleChangeReceiverId={(receiverId: string) =>
