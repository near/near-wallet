...
export default function AccountDropdown({ disabled, 'data-test-id': testId }:AccountDropdownProps) {
    ...
    return (
        ...
        >
            ...
            <DropDown
                ...
                title={accountId || ''}
                content={
                    availableAccounts.filter((a:string ) => a !== accountId).map((account: string , i: number) =>
                        <div
                            key={i}
