...
const AlertContainer = styled.div<{types: string[]}>`
    position: fixed;
    right: 16px;
    z-index: 2100;
...
const Alert = styled.div<AlertContainerProps>`
    background-color: #fff;
    border-left: 4px solid;
    box-shadow: 0px 2px 4px rgba(0, 0, 0, 0.04);
    border-color: ${(props:AlertContainerProps) => props.success ? '#02ba86' : '#e41d22'};
    margin-bottom: 12px;
    ...
    &.number-${(props:AlertContainerProps) => props.closing.toString()} {
...
type HeaderProps = {success: boolean}

const Header = styled.div`
    font-weight: 600;
    margin-bottom: 8px;
    color: ${(props:HeaderProps) => props.success ? '#02ba86' : '#e41d22'};
`;
...
type GlobalAlertNewProps = {
    globalAlert:{[type:string]: {show: string; success:string;messageCode: string;errorMessage: string; messageCodeHeader: string;}};
    actionStatus: {[type:string]: {show: string; success:string;messageCode: string;errorMessage: string; messageCodeHeader: string;}};
    clearGlobalAlert:(type: string)=> void; 
    closeIcon?: boolean;
}

const GlobalAlertNew = ({ globalAlert, actionStatus, clearGlobalAlert, closeIcon = true }:GlobalAlertNewProps) => {
