...
import burrowIcon from './media/burrow.jpg';
import collectNFTsSectionIcon from './media/collectNFTsSectionIcon.svg';
import cryptoheroeIcon from './media/cryptoheroes.jpg';
import dragonflyCapitalPartnersIcon from './media/dragonfly-capital-partners.jpg';
import exchangeSectionIcon from './media/exchangeSectionIcon.svg';
import galaxyOnlineIcon from './media/galaxy-online.jpg';
import hashRushIcon from './media/hash-rush.jpg';
...
import parasIcon from './media/paras.jpg';
...
import rainbowbridgeIcon from './media/rainbow-bridge.jpg';
