...
type SetRecoveryMethodSuccessProps = {
    recoverWithEmail: boolean;  
    phoneNumber: string;
    email: string;
    handleConfirmMessageReceived: ()=> void;
    handleEnterNewRecoverValue: ()=> void;
}

class SetRecoveryMethodSuccess extends Component<SetRecoveryMethodSuccessProps> {
