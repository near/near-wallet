...
import RecoveryOption from '../../recovery_setup/RecoveryOption';
...
type SetupRecoveryImplicitAccountProps = {
    onClickSecureMyAccount: (params : {
        recoveryOption: string;
        email: string;
    })=> void;
    email: string;
    isInitializingRecoveryLink: boolean;
...
export default ({
    ...
    setEmail
}:SetupRecoveryImplicitAccountProps) => {
    const [recoveryOption, setRecoveryOption] = useState<string>('phrase');
