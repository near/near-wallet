...
export function VerifyAccountWrapper() {
    ...
    const implicitAccountId = URLParams.implicitAccountId[0];
    ...
    return (
        <VerifyAccount
            ...
            onChangeVerificationEmail={(e:React.ChangeEvent<HTMLInputElement>) => setVerificationEmail(e.target.value)}
            verificationNumber={verificationNumber}
            onChangeVerificationNumber={(number: string) => setVerificationNumber(number)}
