...
const AnimateList = styled.div`
    ...
    & > div:first-of-type {
        margin-top: ${(props:AnimateListProps) => `-${props.animate * 60}px`};
        transition: 1s;
    }
...
type ImportAccountsProps = {
    accountsApproved: number;
    totalAccounts: number;
    ledgerAccounts: {accountId: string;status: string;}[];
    accountsError: number;
    accountsRejected:number;
    signInWithLedgerStatus: string;
    handleContinue: ()=> void;
