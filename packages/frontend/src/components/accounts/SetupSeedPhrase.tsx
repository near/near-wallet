...
type SetupSeedPhraseProps = RouteComponentProps &  {
    accountId: string;
    history: History<LocationState>;
    location: Location;
    fetchRecoveryMethods: (props: {accountId: string})=>void;
    checkIsNew: (accountId: string)=> boolean;
    handleAddAccessKeySeedPhrase: (accountId: string, recoveryKeyPair:string)=> void;
    handleCreateAccountWithSeedPhrase: (accountId: string, recoveryKeyPair: string, fundingOptions:{fundingAmount: string}, recaptchaToken: null)=> void;
    fundCreateAccount:(accountId:string, recoveryKeyPair:string, phrase:string)=> void;
    ...
    setLinkdropAmount: (fundingAmount: string)=> void;
    recoveryMethods: {kind: string}[];
...
class SetupSeedPhrase extends Component<SetupSeedPhraseProps, SetupSeedPhraseState > {
    recaptchaRef = null
...
//@ts-ignore
export const SetupSeedPhraseWithRouter: any = connect(mapStateToProps, mapDispatchToProps)(withRouter(SetupSeedPhrase));
