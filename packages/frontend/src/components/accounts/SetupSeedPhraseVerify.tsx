...
import {Token} from '../send/SendContainerV2'
...
type SetupSeedPhraseVerifyProps = {
        enterWord:string;
        wordId: number;
        ...
        onRecaptchaChange: (token: Token)=> void;
        isNewAccount: boolean;
        onSubmit: (e:any)=> void;
        isLinkDrop: boolean;
        hasSeedPhraseRecovery: boolean;
