...
type SetupRecoveryMethodProps = {
    router: RouteComponentProps<any>;
    checkIsNew: (accountId: string)=> boolean;
    activeAccountId: string;
    accountId: string;
    get2faMethod:()=> void;
    getLedgerKey: ()=> void;
    fetchRecoveryMethods:(params: {accountId: string})=> void;
    googleReCaptchaProps: {executeRecaptcha: (action: string)=> void};
    location: Location;
    redirectTo:(path: string)=> void;
    fundCreateAccount:(accountId: string, recoveryKeyPair:KeyPair, kind:string)=> void;
    createNewAccount: (params: { accountId:string, fundingOptions:string, recoveryMethod: string, publicKey: string, recaptchaToken: any })=> void;
    validateSecurityCode: (accountId: string, method: string, securityCode: string, validateSecurityCodeEnterpriseRecaptchaToken: any, recoveryMethod: string, publicKey: string)=> void;
    initializeRecoveryMethod:(accoundId: string, method:  {
        kind: string;
        detail: string;
    })=> string; 
    setLinkdropAmount:(amount: string)=> void;
    addLocalKeyAndFinishSetup:(params: { accountId: string, recoveryMethod: string, publicKey: string })=> void;
    createIdentityFundedAccount:(params: {
        accountId: string;
        kind:string,
        publicKey: string,
        identityKey: string,
    ...
    setupRecoveryMessage:(accountId:string, method: {
        kind: string;
        detail: string;
    }, securityCode: string, recoverySeedPhrase: string)=> void;
    showCustomAlert: (params: {
        success?: boolean;
        messageCodeHeader?: string;
        messageCode?: string;
        errorMessage?: string;
    })=> void;
    recoveryMethods: {confirmed: boolean; kind: string; }[];
    mainLoader: boolean;
    ledgerKey: string;
    twoFactor: boolean;
    recoveryMethodsLoader: boolean;
    continueSending: boolean;
    reSending:boolean;
    verifyingCode: boolean;
} 

type SetupRecoveryMethodState = {
    option?: string;
    phoneNumber?: string;
    email?: string
    country?: string;
    ...
    settingUpNewAccount?:boolean;
}

class SetupRecoveryMethod extends Component<SetupRecoveryMethodProps,SetupRecoveryMethodState> {
    ...
    emailInput:React.RefObject<HTMLInputElement> = createRef()
    phoneInput:RefObject<PhoneInput> = createRef()
