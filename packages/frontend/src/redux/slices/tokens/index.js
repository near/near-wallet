...
const fetchOwnedTokensForContractWithMeta = createAsyncThunk(
    `${SLICE_NAME}/fetchOwnedTokensForContractWithMeta`,
    async ({ accountId, contractName }, thunkAPI) => {
...
export const actions = {
    fetchTokens,
    fetchOwnedTokensForContractWithMeta,
    ...tokensSlice.actions
};
...
export const selectOneTokenWithMetadataForAccountId = createSelector(
    [selectOneContractMetadata, selectOneTokenFromOwnedTokens],
    (metadata, tokenInfo) => {
        return {
